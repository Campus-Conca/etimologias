...
<p class="pista-mazos">Cada día es un mazo de láminas. En clase se proyectan una por una con el botón <strong>Presentar</strong>; aquí se quedan apiladas, en orden, para volver a ellas cuando quieras. Debajo de los mazos: el cazador de mitos para jugar, las señales de alarma, las tarjetas y el muro de mitos cazados por el grupo.</p>

<!-- ============================ MARTES ============================ -->
<section class="mazo" id="martes">
<div class="mazo-cabeza">
<div>
<div class="cuando">Martes 6 de octubre · 1 hora</div>
<h3>Las señales de alarma</h3>
<p class="foco">Mientras más bonita la historia, más vale la pena verificarla.</p>
</div>
...
<p class="apoyo">Sin resumen y sin recomendación forzada. El segundo círculo es la semana que entra: si vas a la mitad, hoy es buen día para decirlo.</p>
<p class="nota-conductor">Antes, tu minuto con el ticket de la semana 10: lo turbio y qué haces hoy con eso. Luego el minuto del lector con la lista. Aviso corto: el círculo 2 cae el viernes 16, y quien no haya terminado su segunda obra va igual.</p>
</section>
<section class="lam lam--bitacora">
<h4>La bitácora del lector <span class="reloj">1 min</span></h4>
<p class="di">Falta una semana para el círculo. Abre la tarjeta <em>Antes del círculo</em> y ve marcando tu frase.</p>
<img class="qr-lam" src="../assets/img/qr-bitacora-lector.png" alt="Código QR de la bitácora del lector">
<p class="recurso"><a href="../recursos/plantillas/bitacora-lector.html" target="_blank" rel="noopener">Bitácora del lector</a><span class="pie">La tarjeta del círculo 2 se abre sola cuando toca. Nadie la lee por dentro: cuenta lo que salga de ella.</span></p>
...
<h4><span class="n">2</span> Ritual: ¿te acuerdas del impostor? <span class="reloj">5 min</span></h4>
<span class="senal senal--aire">Al aire</span>
<p class="di">En la semana 3 alguien de este salón inventó un origen falso y se lo creyeron. ¿Quién fue, y cómo lo logró?</p>
<p class="apoyo">Dos o tres recuerdos rápidos. Fíjense en el truco: los que engañaron contaron una historia redonda, con un detalle concreto, dicha con seguridad. Exactamente lo que vamos a aprender a cazar.</p>
<p class="nota-conductor">Se paga la deuda de la semana 3: el impostor etimológico fue el ensayo de esta semana. Si nadie se acuerda, cuenta tú el que mejor haya salido. La lección es una: engañar con una etimología es fácil, y por eso se verifica.</p>
</section>
<section class="lam lam--oscura">
<h4><span class="n">3</span> La historia perfecta <span class="reloj">8 min</span></h4>
<p class="palabra-grande">cadáver</p>
<p class="di">"Viene de las iniciales de Caro Data Vermibus: carne dada a los gusanos."</p>
<p class="apoyo">Macabra, redonda, memorable. Suena a latín de verdad. Apuesten: ¿verdadera o falsa?</p>
<p class="nota-conductor">Deja que voten a mano alzada antes de revelar. Suele ganar "verdadera", y ese es el punto: la historia convence porque es buena, no porque sea cierta.</p>
</section>
<section class="lam">
...
<section class="lam">
<h4><span class="n">4</span> Las señales, al pizarrón <span class="reloj">10 min</span></h4>
<p class="di">Cuatro señales que encienden la alarma. La quinta la ponen ustedes.</p>
<table>
...
<p class="apoyo">A eso se le llama <strong>paretimología</strong> o etimología popular: una historia de origen que la gente inventa porque suena lógica, y que circula sin fuente. Las señales no dictan el veredicto: solo dicen dónde mirar primero. El veredicto lo dicta la fuente, el jueves.</p>
...
<p class="recurso"><a href="../ejercicios/semana-11/ejercicio-11A-caceria-guiada.html" target="_blank" rel="noopener">Cacería guiada</a><span class="pie">Seis casos, cinco señales, y ninguna respuesta hasta el jueves.</span></p>
<p class="nota-conductor">Resiste la tentación de revelar: si alguien pregunta "¿y siesta sí es verdad?", la respuesta es "el jueves, con la fuente". La mitad de los casos son verdaderos a propósito, para que el escepticismo automático también se caiga. Recoge las capturas en la plantilla del tablero.</p>
</section>
<section class="lam lam--actividad">
<h4><span class="n">6</span> Antes del miércoles <span class="reloj">5 min</span></h4>
<span class="senal senal--casa">Para llevar a casa</span>
<p class="di">Trae la etimología que te contaron en casa, y la que te dio la IA, copiada tal cual.</p>
<p class="apoyo">Si no hiciste la tarea del viernes, hoy en la noche: pregúntale a cualquier IA "¿de dónde viene la palabra X?" con una palabra que tú elijas, y copia la respuesta completa, con todo y su seguridad. Mañana el equipo ficha cuatro historias y al menos una tiene que venir de una IA.</p>
</section>
</section>
...
<div class="mazo-cabeza">
<div>
<div class="cuando">Miércoles 7 de octubre · 1 hora</div>
<h3>El expediente de mitos</h3>
<p class="foco">Cuatro historias que se cuentan por ahí. Hoy se fichan; el jueves van a juicio.</p>
</div>
<button class="btn-presentar" type="button">Presentar ▸</button>
</div>
<section class="lam">
<h4><span class="n">1</span> Ritual: los mitos de casa <span class="reloj">6 min</span></h4>
<span class="senal senal--aire">Al aire</span>
<p class="di">¿Qué historia de origen te contaron, y quién te la contó?</p>
...
<p class="recurso"><a href="../ejercicios/semana-11/ejercicio-11B-expediente-de-mitos.html" target="_blank" rel="noopener">El expediente de mitos</a><span class="pie">Cuatro mitos, un equipo, y la agenda del jueves.</span></p>
...
<div class="mazo-cabeza">
<div>
<div class="cuando">Jueves 8 de octubre · 1 hora · centro de cómputo</div>
<h3>El gran tribunal de los mitos</h3>
<p class="foco">El martes apostaste. Hoy hablan las fuentes y el mundo se divide en cuentos y hechos.</p>
</div>
<button class="btn-presentar" type="button">Presentar ▸</button>
</div>
<section class="lam lam--oscura">
<h4><span class="n">1</span> La regla mayor del cazador <span class="reloj">5 min</span></h4>
<p class="di">El veredicto lo dicta la fuente. Nunca el primer resultado del buscador, nunca la IA, nunca la corazonada.</p>
<p class="apoyo">Y la segunda regla, que casi nadie espera: <strong>el tribunal también confirma verdades</strong>. Si tu escepticismo derriba todo lo que suena raro, no estás cazando mitos: estás adivinando al revés. <em>Siesta</em> viene de la hora sexta. <em>Bárbaro</em> viene de "bar-bar". Las dos parecen cuento y las dos están en la fuente.</p>
</section>
<section class="lam">
<h4><span class="n">2</span> Cómo se lee una fuente que desmiente <span class="reloj">7 min</span></h4>
<table>
...
<p class="apoyo">Si el DLE y el DECEL no coinciden, documenta las dos versiones: eso vale doble. Y si la fuente dice "quizá" o "de origen incierto", tu veredicto es "sigue dudosa", que es un veredicto honesto y no una derrota.</p>
<p class="nota-conductor">Proyecta la entrada de <em>sincero</em> en el DLE y luego la del DECEL, que además explica por qué la leyenda de "sin cera" es falsa. Es el modelo de lectura que van a repetir con sus casos: primero el paréntesis, luego la historia.</p>
</section>
<section class="lam lam--actividad">
<h4><span class="n">3</span> Gimnasio: el gran tribunal <span class="reloj">33 min</span></h4>
<span class="senal">Actividad · individual, con las fuentes abiertas</span>
<p class="di">Tus tres mejores casos, con veredicto, etimología documentada y fuente.</p>
<p class="apoyo"><a href="../ejercicios/semana-11/ejercicio-11C-gran-tribunal.html">El gran tribunal de los mitos</a>: de los seis del martes y los cuatro del expediente eliges tres. Por cada uno: la historia que se cuenta, el veredicto (confirmada, derribada o sigue dudosa), la etimología documentada y la nota de fuente. El ejercicio no deja derribar un mito sin decir cuál es la etimología verdadera: no basta decir que la historia es falsa. Los mejores casos se proponen para el muro de esta página.</p>
<p class="recurso"><a href="../ejercicios/semana-11/ejercicio-11C-gran-tribunal.html" target="_blank" rel="noopener">El gran tribunal de los mitos</a><span class="pie">Tres casos, tres veredictos, y la fuente en la mano.</span></p>
<p class="nota-conductor">El caso obligatorio de cada quien es el de la IA de su equipo: que lo lleven a la fuente y comparen párrafo por párrafo. Cuando la IA acertó, también se anota: la conclusión no es "la IA siempre miente", es "no se sabe hasta que se verifica". Circula buscando quién usa el buscador en lugar del DLE: es el error del día.</p>
</section>
<section class="lam lam--actividad">
<h4><span class="n">4</span> Al muro <span class="reloj">8 min</span></h4>
<span class="senal">Actividad · individual</span>
<p class="di">El mito más difundido que cayó, y la verdad más increíble que quedó de pie.</p>
<p class="apoyo">Abajo, en <a href="#sube-tu-caso-al-muro">Sube tu caso al muro</a>, está el formulario: palabra, la historia que se cuenta, el veredicto, la etimología documentada y la fuente. El profesor revisa y los publica en "Lo que produjimos", con nombre de pila si lo das. Sube uno: el que más te sorprendió.</p>
<p class="nota-conductor">El formulario cae en la pestaña <em>general</em> del recolector (no hay tipo propio para mitos): palomea los que suben, genera el bloque con el menú Cosecha y pégalo entre las marcas de "Lo que produjimos" de esta página, en la variable MITOS. Revisa antes de publicar que la etimología documentada sea la de la fuente, no otra leyenda.</p>
</section>
<section class="lam">
<h4><span class="n">5</span> El marcador <span class="reloj">7 min</span></h4>
<span class="senal senal--aire">Al aire</span>
<p class="di">¿Cuántos mitos cayeron? ¿Cuántas verdades increíbles quedaron de pie? ¿Cuántas veces acertó la IA?</p>
<p class="apoyo">Tres números al pizarrón. El tercero es el que más sorprende: la IA acierta seguido, y aun así no sirve como fuente, porque no hay manera de saber cuándo acertó sin verificar. Mañana: quiz relámpago y la biografía de una palabra con leyenda. Ve eligiendo la tuya.</p>
</section>
</section>
...
<div class="mazo-cabeza">
<div>
<div class="cuando">Viernes 9 de octubre · 2 horas</div>
<h3>La palabra con leyenda</h3>
<p class="foco">Una biografía con dos versiones: la que se cuenta y la que documentan las fuentes.</p>
</div>
<button class="btn-presentar" type="button">Presentar ▸</button>
</div>
<section class="lam lam--actividad">
<h4><span class="n">1</span> Ritual: quiz relámpago <span class="reloj">15 min</span></h4>
<span class="senal">A solas · sin mazo y sin celular</span>
<p class="di">Tres reactivos. Tu apuesta primero, del 0 al 3.</p>
<p class="apoyo">Dictaminar una historia de origen, reconocer una verdad que parece mito, y decir qué se hace con una etimología que da la IA. En el cuadernillo, se califica en el momento, y los dos números van al renglón del <strong>quiz #9</strong> de tu expediente: el último antes del integrador de la unidad.</p>
<p class="recurso"><a href="../ejercicios/semana-11/quiz-relampago-semana-11.html" target="_blank" rel="noopener">El quiz, lámina por lámina</a><span class="pie">El mismo que se proyecta, con cronómetro de tres minutos y las respuestas al final.</span></p>
...
<p class="apoyo">El DLE lo anota con dos palabras: "influido por" (<em>cerrojo</em>: "del lat. <em>verucŭlum</em>, infl. por <em>cerrar</em>"). Es la paretimología en su versión seria: una historia falsa tan convincente que termina escribiéndose en la palabra. Por eso las leyendas no se ridiculizan: se explican, porque explican cosas.</p>
...
<section class="lam">
<h4><span class="n">4</span> El muro, proyectado <span class="reloj">10 min</span></h4>
<span class="senal senal--aire">Al aire</span>
<p class="di">Los mitos que cazamos y las verdades que dejamos de pie, con nombre de quien las juzgó.</p>
<p class="apoyo">Se lee en voz alta el muro de <a href="#lo-que-produjimos">Lo que produjimos</a>: por cada caso, la historia que se cuenta y lo que dijo la fuente. Y una pregunta al grupo: ¿cuál de estas historias falsas les gustaría que fuera verdad? Esa es la que van a seguir oyendo toda la vida, y ahora ya saben qué contestar.</p>
<p class="nota-conductor">Si la curaduría no alcanzó, proyecta la plantilla del tablero con las capturas del jueves. Lo importante es que el veredicto se diga con la fuente en voz alta.</p>
</section>
<section class="lam">
<h4><span class="n">5</span> Puente a la semana 12: ¿quién es dueño del español? <span class="reloj">12 min</span></h4>
<p class="di">La unidad cierra la semana que entra. Esto es lo que debe existir.</p>
<table>
...
<p class="apoyo">El cierre de siempre. Hoy, si se puede, una historia que parezca mentira y sea verdad.</p>
...
<div class="cosecha"
     data-tipo="general"
     data-titulo="Sube tu caso al cazador de mitos"
     data-nota="Un caso por persona: el que más te sorprendió del tribunal. Escribe tu nombre de pila como quieras que aparezca, o 'anónimo'."
     data-campos='[
       {"n":"palabra","t":"La palabra","req":true},
       {"n":"historia","t":"La historia que se cuenta, tal como circula","req":true},
       {"n":"veredicto","t":"Veredicto: confirmada, derribada o sigue dudosa","req":true},
       {"n":"nota","t":"La etimología documentada (lo que dice la fuente)","req":true},
       {"n":"fuente","t":"Fuente (DLE, DECEL) y qué dijo cada una","req":true}
     ]'></div>
...
(function(){
  var C=[
   ...
   {claim:"gringo viene de 'green go home' gritado a los soldados.",real:false,txt:"Falso. La explicación más aceptada: de griego, porque 'hablar en griego' era hablar raro, incomprensible. El DLE lo dice con 'quizá', y aun así descarta el inglés."},
   ...
   {claim:"OK viene de '0 killed' (cero muertos) en la guerra.",real:false,txt:"Falso. Nació como broma en Estados Unidos hacia 1839: 'oll korrect', all correct mal escrito."},
   {claim:"mermelada viene de 'Marie malade', el dulce de una reina enferma.",real:false,txt:"Falso. Viene del portugués marmelada, dulce de membrillo (marmelo). Enciende dos señales: demasiado redonda y otra lengua sin razón."},
   ...
   {claim:"murciélago viene de 'mur ciego', el ratón ciego.",real:true,txt:"Verdadero. Del antiguo murciégalo: mur (ratón) más ciego. Parece cuento y es la fuente."},
   ...
   {claim:"morfina viene de Morfeo, el dios griego del sueño.",real:true,txt:"Verdadero. La bautizó así un farmacéutico a principios del siglo XIX porque produce sopor. A veces la historia increíble es la documentada: por eso se verifica."}
  ];
...
<div id="mitos-muro"></div>

<style>
.mitos-muro{display:grid;grid-template-columns:repeat(auto-fill,minmax(17rem,1fr));gap:.8rem;margin:.8rem 0 1.4rem}
.mito{border:1px solid #e6dff0;border-radius:.9rem;background:#fff;padding:.9rem 1rem;box-shadow:0 1px 4px rgba(107,30,90,.07)}
.mito b{display:block;font-family:"Bricolage Grotesque","Inter",sans-serif;font-size:1.25rem;color:#6b1e5a}
.mito .mt-hist{font-style:italic;color:#4a2440;font-size:.92rem;border-left:3px solid #f4a8ce;padding-left:.6rem;margin:.4rem 0}
.mito .mt-ver{display:inline-block;font-size:.7rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;padding:.2rem .6rem;border-radius:2rem;margin:.2rem 0}
.mito .mt-ver.cae{background:#fdecec;color:#a3312b}
.mito .mt-ver.pie{background:#dff5ee;color:#0b5f52}
.mito .mt-ver.duda{background:#fbf0d9;color:#7a5a0b}
.mito .mt-real{font-size:.92rem;color:#2b2440;margin-top:.3rem}
.mito .mt-fuente{font-size:.8rem;color:#666;margin-top:.2rem}
.mito .mt-quien{font-size:.76rem;color:#c4006a;font-weight:700;margin-top:.4rem}
.mitos-vacio{border:1px dashed #d9c3d4;border-radius:.9rem;padding:1rem 1.1rem;background:#fdf9fc;color:#6b1e5a;font-style:italic}
</style>

<script>
(function(){
  function esc(s){return String(s==null?'':s).replace(/[&<>"]/g,function(c){return {'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;'}[c];});}
  var datos=window.MITOS||[],muro=document.getElementById('mitos-muro');
  if(!muro)return;
  if(!datos.length){muro.innerHTML='<div class="mitos-vacio">El muro se llena el jueves 8 de octubre, con los casos que el grupo lleve al tribunal.</div>';return;}
  muro.className='mitos-muro';
  muro.innerHTML=datos.map(function(m){
    var v=(m.veredicto||'').toLowerCase();
    var cl=v.indexOf('derrib')>-1||v.indexOf('fals')>-1?'cae':(v.indexOf('confirm')>-1||v.indexOf('verdad')>-1?'pie':'duda');
    var t='<div class="mito"><b>'+esc(m.palabra)+'</b>';
    if(m.historia)t+='<div class="mt-hist">'+esc(m.historia)+'</div>';
    if(m.veredicto)t+='<span class="mt-ver '+cl+'">'+esc(m.veredicto)+'</span>';
    if(m.nota)t+='<div class="mt-real">'+esc(m.nota)+'</div>';
    if(m.fuente)t+='<div class="mt-fuente">Fuente: '+esc(m.fuente)+'</div>';
    if(m.nombre)t+='<div class="mt-quien">Lo juzgó: '+esc(m.nombre)+'</div>';
    return t+'</div>';
  }).join('');
})();
</script>
