...
<p class="foco">Hoy una sola pieza te va a regalar diez palabras.</p>
</div>
...
<span class="eq">= hemorragia</span>
</div>
<img class="ilustracion" src="../assets/img/semana-05/la-llave-maestra.webp" alt="Una figura dibujada a mano levanta una llave rosa enorme rotulada hemo-, sangre, frente a una hilera de seis puertas: hemorragia, hemofilia, hemoglobina, hematoma, anemia y hemodiálisis; las primeras están abiertas con luz y las últimas siguen cerradas con la misma cerradura">
<p class="apoyo">Con esa sola pieza ya puedes leer hemofilia, hemoglobina, hematoma, hematología y hemodiálisis. Y una que no empieza con hemo pero es de la casa: <em>anemia</em>, sangre que falta, con el <em>an-</em> que traes desde la semana 2. Nadie te enseñó ninguna una por una.</p>
<p class="nota-conductor">Escribe hemo- en el pizarrón y pide palabras a mano alzada antes de dar la lista. Siempre sale hemorragia primero; anemia casi nunca, y es la que conviene celebrar.</p>
</section>
<section class="lam lam--oscura">
<h4>La cuenta que importa</h4>
<p class="di">No es cuántas palabras sabes. Es cuántas te regala cada pieza que aprendes.</p>
...
<span class="eq">= pulpo</span>
</div>
<img class="ilustracion" src="../assets/img/semana-05/el-pulpo-cuenta-sus-pies.webp" alt="Un pulpo rosa dibujado a mano cuenta sus ocho brazos con etiquetas numeradas del 1 al 8, bajo un letrero que dice polýpous, muchos pies; a la derecha, unidos por una línea punteada, sus parientes: un trípode, un podio y un globo terráqueo con dos figuras paradas en lados opuestos">
<p class="apoyo">Del griego <em>polýpous</em>: muchos pies. Lo que tú llamas tentáculos, los griegos lo contaron como patas, y por eso el pulpo es pariente del <em>trípode</em>, del <em>podio</em>, del <em>podólogo</em> y de las <em>antípodas</em>, esa gente que tiene los pies exactamente del otro lado del planeta.</p>
<p class="nota-conductor">Pregunta primero: ¿de qué familia creen que viene "pulpo"? Nadie dice "pie". Ahí está el gancho del día.</p>
</section>
<section class="lam">
...
<img class="ilustracion" src="../assets/img/semana-05/el-cosmos-y-el-cosmetico.webp" alt="La hoja partida por una línea: a la izquierda, en rosa, una persona se peina frente a un espejo con el labial y el peine acomodados en la mesa; a la derecha, en azul, estrellas, un planeta con anillo y la luna puestos en filas ordenadas; abajo, uniendo las dos escenas con flechas, un letrero dice kósmos, orden">
...
<div class="dis">
<span class="pz pz--pre">hypó<small>debajo, de menos</small></span>
<span class="eq">→ hipotermia, hipoglucemia</span>
</div>
<div class="dis">
<span class="pz pz--raiz">híppos<small>caballo</small></span>
<span class="eq">→ hipódromo, hipopótamo, hipocampo</span>
</div>
<img class="ilustracion" src="../assets/img/semana-05/los-dos-hipo.webp" alt="Un bloque rotulado hipo- se parte por una grieta y se abre en dos flechas: la de la izquierda, hypó, debajo o de menos, lleva a un termómetro azul con la flecha hacia abajo y la palabra hipotermia; la de la derecha, híppos, caballo, lleva a un caballo corriendo en una pista ocre y la palabra hipódromo; en medio, una figura con un libro dice solo la fuente distingue">
<p class="apoyo">Se escriben igual en español y no tienen absolutamente nada que ver. Es el mismo tipo de trampa que <em>mango</em> en la semana 3: dos piezas idénticas a la vista, con padres distintos. <strong>Solo la fuente distingue.</strong> Guárdate esta lección: vale para todo el semestre, y va a caer en el integrador.</p>
...
<p class="foco">Gana el que busca lejos, no el que grita rápido.</p>
</div>
<button class="btn-presentar" type="button">Presentar ▸</button>
</div>
<section class="lam lam--actividad">
...
<p class="recurso"><a href="../ejercicios/semana-05/quiz-relampago-semana-05-viernes.html" target="_blank" rel="noopener">El quiz, lámina por lámina</a><span class="pie">Los diez reactivos como se proyectan, con cronómetro de cinco minutos y con las respuestas.</span></p>
...
<p class="apoyo">En griego, <em>páthos</em> era el sentimiento: todo lo que a uno le pasa por dentro. Con ese sentido nacieron <em>apatía</em> (sin sentimientos), <em>simpatía</em> (sentir con el otro) y <em>antipatía</em> (sentir en contra).</p>
<p class="apoyo">Después <em>páthos</em> pasó a significar la pasión. Y cuando los griegos decidieron que la pasión era una enfermedad del alma que nubla la razón, la raíz terminó significando enfermedad: de ahí <em>patología</em> y <em>patógeno</em>. Una sola raíz, tres épocas de significado, y todas siguen vivas en tu boca: cuando dices que alguien te cae simpático y que un virus es patógeno, usas la misma raíz en dos momentos distintos de su vida.</p>
...
(function(){
  var R={
   "hemo- (sangre)":["hemorragia","hemofilia","hemoglobina","hematoma","hematología","hemodiálisis","anemia","hemograma","hemostasia","hemocultivo"],
   "cosmo- (orden, mundo)":["cosmos","cosmético","cosmopolita","microcosmos","macrocosmos","cosmonauta","cosmología","cosmogonía"],
   "-nauta (navegante)":["astronauta","cosmonauta","internauta","náutico","náusea","argonauta","aeronauta","nautilo"],
   "-polis (ciudad)":["metrópoli","acrópolis","necrópolis","megalópolis","cosmopolita","política","policía","metropolitano"],
   "-podo (pie)":["podólogo","podio","trípode","pulpo","antípoda","artrópodo","miriápodo","seudópodo","podómetro"],
   "zoo- (animal)":["zoológico","zoología","protozoo","zodiaco","zoofobia","zoolatría","espermatozoide","zootecnia"],
   "-teca (depósito, caja)":["biblioteca","discoteca","hemeroteca","pinacoteca","filmoteca","videoteca","ludoteca","fototeca"],
   "-nomía (ley, regla)":["astronomía","economía","gastronomía","autonomía","agronomía","taxonomía","ergonomía"],
   "hipo- (caballo)":["hipódromo","hipopótamo","hipocampo","hípico","hipismo","Felipe","hipogrifo"],
