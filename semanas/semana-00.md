...
## Miércoles · Taller del gimnasio

Hoy queda funcionando tu sistema de repaso, el que sea tuyo:

- **Anki**: creas tu mazo "Etimologías" y tu cuenta de AnkiWeb para sincronizar. Quien ya lo tiene ayuda a quien no.
- **Caja Leitner**: la versión de papel, con cien años de ventaja sobre Anki. Tres compartimentos: el 1 se repasa a diario; si aciertas, la tarjeta sube al 2 (cada tercer día) y luego al 3 (semanal); si fallas, regresa al 1. Mismo algoritmo, cero baterías. Opción legítima, no plan de emergencia.
...
## Viernes · La inaugural (2 horas)

La sesión grande de la semana, con todo el menú:
